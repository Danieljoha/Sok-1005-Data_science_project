...
invisible(map(dominicks_98_plotly, print))
```
...
In the beginning of Task 1 there has been use for ChatGPT to help define the start of "week 1" as we were unsure of how to convert the weekly data to date but it gave us the idea which we used to create the code. Codeline 111 and 119

We used ChatGPT to enter in the variable names after posting the variable names from the PDF. Codelines 130-140

In the code line 224 we had help from ChatGPT to write the REGEX code to help us pick out the brands as the brands had weird names with changing use of letters and such.
